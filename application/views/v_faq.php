...
<body class="one-page" data-target="#header" data-spy="scroll" data-offset="100">
		...
		<header id="header" class="header-transparent header-effect-shrink" data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyChangeLogo': true, 'stickyStartAt': 30, 'stickyHeaderContainerHeight': 70}">
				...
				<section id="contact" class="section bg-color-primary border-0 m-0">
					<div class="container-fluid">
						<div class="row mb-5">
							<div class="col text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
								<h2 class="font-weight-bold text-color-light mb-2">Frequently Asked Questions</h2>
								<p class="text-color-light opacity-7">Pertanyaan yang Sering Diajukan</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3"></div>
							<div class="col-md-6">
								<div class="list-group" id="tampil_pertanyaan"></div>
							</div>
							<div class="col-md-3"></div>
	...
	<!-- Modal -->
									<div class="modal fade" id="jawab" role="dialog">
										<div class="modal-dialog modal-lg" role="document">
  											  <div class="modal-content">
     											 <div class="modal-header text-center bg-primary">
												  <h4 class="modal-title w-100 font-weight-bold text-color-light">Jawaban</h4>
	...
	<!-- Vendor -->
		...
		<script type="text/javascript">
			//muat pertanyaan 
			$.getJSON("<?= base_url()?>Faq/get_tabel_faq",function(data){
				var tampil="";
				$.each(data,function(key,dt){
					tampil+=
					'<a href="#jawab" class="list-group-item list-group-item-info text-center" data-toggle="modal" style="text-decoration: none;" onclick="tm_detail('+dt['id_faq']+')">'+dt['pertanyaan']+'</a>';
				});
				$('#tampil_pertanyaan').html(tampil);
			});

			//muat jawaban
			function tm_detail(id_faq)
			{
				$.getJSON("<?= base_url()?>Faq/jawab/"+id_faq,function(data){
					$('#gambar').html(
